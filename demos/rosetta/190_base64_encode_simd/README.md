...
- `main.rs`: copied from `/home/vscode/projects/sci/demos/rosetta/190_base64_encode_simd/main.rs`.
...
SA_PLUGIN_DEV=1 sa sla test demos/rosetta/190_base64_encode_simd/main.sla
```
