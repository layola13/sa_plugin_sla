...
- Current full dev-mode direct SAB no-fallback sweep: 70/70 passing.
- Current global estimates: Y/shared-lowering about 93%; direct SAB fallback-removal is 100% for the tracked unit corpus, with corpus pass rate now 70/70.
- Current feature report: `ready Future/task runtime surface 100%; no-fallback sweep is 70/70; committed in this slice`.
